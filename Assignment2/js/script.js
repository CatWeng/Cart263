...
const AVATAR_SIZE_LOSS_PER_FRAME = 0.6;
const FOOD_MIN_SIZE = 20;
const FOOD_MAX_SIZE = 80;
const FOOD_SPEED_MAX = 20;
...
function setup() {
  ...
  for (let i=0; i < 5; i++){
    food.push(new Food(random(0,width),random(0,height),FOOD_MIN_SIZE,FOOD_MAX_SIZE,FOOD_SPEED_MAX));
  }
  noCursor();
}
